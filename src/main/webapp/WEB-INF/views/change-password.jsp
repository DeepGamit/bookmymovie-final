...
<head>
    ...
    <title>Change Password :: BookMyMovie.com</title>
</head>
<body>
	...
	<div class="container">
		...
		<form:form modelAttribute="user" action="/bookmymovie/change-password/updatePassword" method="post">
            ...
            <div class="form-group">
            	<div class="input-group mb-3">
                	...
                	<form:password path="userPwd" class="form-control" name="userPwd" placeholder="New Password" />		
                </div> 
	        ...
	        <button type="submit" class="btn btn-info btn-block btn-lg">UPDATE PASSWORD</button>
		</form:form> 
	</div>
